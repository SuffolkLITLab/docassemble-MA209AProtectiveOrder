...
setup(name='docassemble.MA209AProtectiveOrder',
      ...
      install_requires=['docassemble.ALToolbox>=0.8.2', 'docassemble.AssemblyLine>=2.26.0', 'docassemble.MACourts>=0.59.1', 'docassemble.MassAccess>=0.3.0', 'docassemble.income'],
      zip_safe=False,
